      ...
      <div class="mb-4">
        ...
        >
          <div class="hidden md:block md:col-span-1">
            <div class="shadow bg-gray-100 rounded px-4 py-4 h-auto mb-4">
              <div class="mb-3 flex justify-between">
                <h1 class="text-gray-700 font-normal cursor-pointer">
                  Reading list
                </h1>
                <h1
                  class="text-gray-700 font-normal bg-gray-200 px-1 py-0 rounded"
                >
                  13
                </h1>
              </div>
              <div class="mb-3">
                <h1 class="text-gray-700 font-normal cursor-pointer">Tags</h1>
              </div>
              ...
              <div class="mb-3">
                <h1 class="text-gray-700 font-normal cursor-pointer">About</h1>
              </div>
            ...
            <div class="shadow bg-gray-100 rounded px-4 py-4 h-auto mb-4">
              <div class="flex justify-between items-start">
                <h1 class="font-semibold text-lg text-gray-900 mb-6">
                  My Tags
                </h1>
                <div class="bg-gray-200 px-2 py-1 rounded cursor-pointer">
                  <svg
              ...
              <div class="overflow-y-scroll h-40">
                <a href="" class="block font-normal text-sm text-gray-700 mb-3"
                  >#Laravel</a
                >
                <a href="" class="block font-normal text-sm text-gray-700 mb-3"
                  >#react</a
