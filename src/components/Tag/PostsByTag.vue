<template>
  ...
  <section class="mt-10">
    <div class="px-6 mx-auto">
      <div class="mb-4">
        <div
          class="bg-white rounded-md shadow py-4 px-4 mb-8 border-l-8 border-yellow-600"
        >
          <div class="flex justify-between items-start">
            <h1 class="text-gray-900 md:text-3xl font-bold mb-6 md:mb-2">
              JavaScript
            </h1>
            <button
              class="bg-gray-300 px-2 py-1 md:px-8 md:text-xl md:py-2 rounded text-gray-700 font-semibold"
            >
              Follow
            </button>
          </div>
          <p class="text-sm text-gray-800 leading-6 w-3/4">
            ...
            JavaScript developers move fast and push software development
            forward; they can be as opinionated as the frameworks they use, so
            let's keep it clean here and make it a place to learn from each
            other!
          </p>
        </div>

        <div
          class="grid grid-cols-3 lg:grid-cols-4 gap-2 lg:gap-4 justify-items-stretch"
        >
          <div class="hidden md:block md:col-span-1">
            <div class="divide-y divide-gray-400">
              <div class="px-4 py-4 h-auto mb-4">
                <h1 class="text-gray-900 text-sm font-medium mb-4">
                  submission guidelines
                </h1>
                <p class="text-sm text-gray-900 mb-3">
                  Client-side, server-side, it doesn't matter. This tag should
                  be used for anything JavaScript focused. If the topic is about
                  a <span class="font-bold">JavaScript</span> framework or
                  library, just remember to include the framework's tag as well.
                </p>
                <button class="bg-blue-base text-white px-2 py-1 rounded">
                  Write a post
                </button>
              </div>
              ...
              <div class="px-4 py-4 h-auto mb-4">
                ...
                <a
                  href="https://randomuser.me/api/portraits/men/17.jpg"
                  target="_blank"
                  class="inline-block bg-white rounded-full mr-2 mb-2 cursor-pointer"
                >
                  <img
                ...
                <a
                  href="https://randomuser.me/api/portraits/men/15.jpg"
                  target="_blank"
                  class="inline-block bg-white rounded-full mr-2 mb-2 cursor-pointer"
                >
                  <img
                ...
                <a
                  href="https://randomuser.me/api/portraits/men/19.jpg"
                  target="_blank"
                  class="inline-block bg-white rounded-full mr-2 mb-2 cursor-pointer"
                >
                  <img
                ...
                <a
                  href="https://randomuser.me/api/portraits/men/22.jpg"
                  target="_blank"
                  class="inline-block bg-white rounded-full mr-2 mb-2 cursor-pointer"
                >
                  <img
                ...
                <a
                  href="https://randomuser.me/api/portraits/men/14.jpg"
                  target="_blank"
                  class="inline-block bg-white rounded-full mr-2 mb-2 cursor-pointer"
                >
                  <img
              ...
              <div>
                <h1 class="px-4 mt-4 text-gray-800 text-sm">
                  <span class="font-medium">32703</span> Posts Published
                </h1>
              </div>
            </div>
          </div>
          ...
          <div class="col-span-3 md:col-span-2">
            ...
            >
              ...
              <div class="py-2 w-4/5">
                <p class="font-bold text-gray-900">
                  What's the best alternative to indexOf() d dqdfqs for checking
                  existence of element in an array erfs ze zer zaerazr az ?
                </p>
                <p class="mt-4 text-gray-800">
                  In most languages, indexOf() returns -1 if element is not
                  found, which IMO is a bit counter productive. What's the best
                  alternative to this...
                </p>

                <div class="flex mt-4">
                  <div class="">
                    <span class="text-sm text-gray-700 mr-1">#Laravel</span>
                    <span class="text-sm text-gray-700 mr-1">#react</span>
                    <span class="text-sm text-gray-700 mr-1">#vue</span>
                    <span class="text-sm text-gray-700 mr-1">#graphql</span>
                    <span class="text-sm text-gray-700 mr-1">#nodejs</span>
                    <span class="text-sm text-gray-700 mr-1">#tailwind</span>
                  </div>
                </div>
              </div>
              ...
              <div class="mt-2">
                <div class="py-2 flex flex-row items-center">
                  ...
                  >
                    ...
                    <span class="ml-1 font-medium text-xs">Add comment</span>
                  </button>
                  <button
            ...
            <div class="px-4 py-4 bg-white shadow-md rounded-lg cursor-pointer">
              <div class="py-2 flex flex-row items-center justify-between">
                <div class="flex flex-row items-center">
                  <a
                    href="#"
          ...
          <div class="hidden md:block md:col-span-1">
            <div class="shadow bg-gray-100 rounded py-4 h-auto mb-4">
              <div class="divide-y divide-gray-300">
                <div class="px-4">
                  <div class="mb-4">
                    <h1
                      class="text-gray-900 font-semibold text-xl cursor-pointer"
                    >
                      #news
                    </h1>
                  </div>
                ...
                <div class="px-4 py-4 mb-3">
                  <h1 class="text-gray-900 cursor-pointer">
                    What's the best alternative to indexOf() d dqdfqs for
                    checking existence of element in an array erfs ze zer
                    zaerazr az ?
                  </h1>
                  <div class="text-xs text-gray-700 mt-2">12 comments</div>
                </div>
                <div class="px-4 py-4 mb-3">
                  <h1 class="text-gray-900 cursor-pointer">
                    What's the best alternative to indexOf() d ?
                  </h1>
                  <div class="text-xs text-gray-700 mt-2">2 comments</div>
                </div>
              </div>
            </div>
